...
?>
<div class="comment-form-container mb-3">
    ...
    <?php echo $form->field($commentModel, 'content', ['template' => '{input}{error}'])->textarea([
        ...
        'rows' => 4, 'data' => ['comment' => 'content']]); 
    ?>
    <?php echo $form->field($commentModel, 'parentId', ['template' => '{input}'])->hiddenInput(['data' => ['comment' => 'parent-id']]); ?>
    <div class="comment-box-partial">
        <div class="button-container show">
            <?php echo Html::a(Yii::t('yii2mod.comments', 'Click here to cancel reply.'), '#', ['id' => 'cancel-reply', 'class' => 'pull-right float-right', 'style' => 'float:right;', 'data' => ['action' => 'cancel-reply']]); ?>
...
<?php 
    if (Yii::$app->user->isGuest){
        $this->registerJs('
            $(\'#commentmodel-content\').focus(function(){
                parent.gotoLogin();
            });
        ');
    }
