...
<section class="body-content">
	<div class="body-white pt-0">
		<div class="container" style="border-left: 1px solid #E2E2E2;border-right: 1px solid #E2E2E2">
			<div class="row pt-5">
				<div class="col-12">
				...
				<div class="col-12 col-lg-8 order-1 order-lg-1">
					<div class="d-flex justify-content-start breadcrum-small">
						<a href="/">
							<img src="/themes/default/ctyluat/img/icon-home.png" width="16" height="16" />
						</a>
						<?php foreach ($breadcrum as $item) : ?>
					...
					<div class="post-info">
						...
						<a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode(Url::base(true) . CFunction::renderUrlNews($news)) ?>" target="_blank">
							<img src="/themes/default/ctyluat/img/icon-fb.png" style="margin-top: -3px;" />
						</a>
					...
					<?php //if (false && $news->id == 4875) { ?>
						<div id="wrap-comment" data-src="<?= Url::toRoute(['comment-embed/index', 'id' => $news->id]) ?>">
							<iframe src="" style="border: medium none;visibility: visible;width: 100%;" id="myIframeComment" frameborder="0" class="w-100" > </iframe>
							<script>
								function loadIframeHeight(height) {
									var iFrameID = $('#myIframeComment');
					...
					<?php //} else { ?>
						 <!-- <div class="fb-comments mt-2" data-href="<?php echo !empty(Yii::$app->controller->canonical) ? Yii::$app->controller->canonical : Yii::$app->request->getAbsoluteUrl(); ?>" data-width="100%" data-numposts="5"></div> -->
					<?php //} ?>
									...
									<div class="row">
										<div class="col-5">
											<a href="<?= CFunction::renderUrlNews($r) ?>">
												<img src="<?= Yii::$app->request->baseUrl . '' . $r['image'] ?>" width="100%" height="auto" />
											</a>
										</div>
										<div class="col-7">
											<div class="box-news3 mt-1" style="text-align: left;">
												<a href="<?= CFunction::renderUrlNews($r) ?>" style="color: inherit; text-decoration: none;">
													<h3 class="box-news3-title mb-0"><?= $r['title'] ?></h3>
												</a>
												<p class="news-category pt-1 pb-2 mb-0">
													<a href="<?= CFunction::renderUrlCategory($r['cid']) ?>">
														<?= $r['cname'] ?>
													</a>
													<span><?= CFunction::diffTime($r['time_active']) ?></span>
												</p>
												<p class="box-news2-des" style="text-align: left;">
													<?= $r['brief'] ?>
												</p>
											</div>
										</div>
