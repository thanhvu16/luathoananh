...
class KLogger
{
	...
	public function __construct( $filepath , $priority )
	{
		...
		$path = Yii::getAlias('@runtime').DS.$filepath.".log";

		if(file_exists($path) && filesize($path) > 30*1024*1024){
			rename($path,Yii::getAlias('@runtime').DS.$filepath."_".date('YmdHis').".log");
		}
	...
	public function LogInfo($line, $show = false)
	{
