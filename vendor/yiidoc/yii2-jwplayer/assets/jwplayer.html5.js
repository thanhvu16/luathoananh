...
(function(h) {
    ...
    h.html5.video = function(d, f) {
        ...
        var xa = Q.seek = function(a) {
                if (O)
                    if (!P && 0 === I && h(b.JWPLAYER_MEDIA_SEEK, {
                            position: G,
                            offset: a
                        }), A) {
                        I = 0;
...
(function(h, k) {
    ...
    e.html5.youtube = function(a) {
        ...
        r.supportsFullscreen = function() {
            return !(!A || !A.requestFullscreen && !A.requestFullScreen && !A.webkitRequestFullscreen && !A.webkitRequestFullScreen &&
            !A.webkitEnterFullscreen && !A.webkitEnterFullScreen && !A.mozRequestFullScreen && !A.msRequestFullscreen)
        };
        r.remove = function() {
            J()
        };
        ...
        r.getQualityLevels = function() {
            if (t) {
                var a = [];
                if (t.getAvailableQualityLevels)
                    for (var c = t.getAvailableQualityLevels(), b = c.length; b--;) a.push({
                        label: c[b]
                    });
                return a
            }
        ...
        c.jwAddEventListener(a.JWPLAYER_PLAYLIST_ITEM, function() {
            ...
            if (!d) {
                for (j = 0; j < f.length; j++)
                    if (h = f[j].file) f[j].label || (f[j].label = j.toString()),
...
(function(h) {
    ...
    b.controlbar = function(d, C) {
                                ...
                                case v:
                                    ...
                                    if (f && 0 === l.indexOf("volume")) B = void 0;
                                        ...
                                        "time" == l ? (pa = new b.overlay(aa + "_timetooltip", $), ib = new b.thumbs(aa + "_thumb"), jb = H.createElement("div"), jb.className = "jwoverlaytext", sb = H.createElement("div"),
                                            B = ib.element(), sb.appendChild(B), sb.appendChild(jb), pa.setContents(sb), eb = K, xb(0), B = pa.element(), K.appendChild(B), F.timeSliderRail || c.style(F.time, w), F.timeSliderThumb && c.style(F.timeSliderThumb, {
        ...
        var $, rb = r("divider", "divider"),
            ta = {
                ...
                layout: {
                    ...
                    right: {
                        position: "right",
                        elements: [r("duration", s), r("hd", m), r("cc",
        ...
        xb = function(b) {
            ...
            if (bb) {
                if ((b =
                        bb.text) && b !== Ab) Ab = b, c.style(pa.element(), {
...
(function(h) {
    ...
    k.display = function(h, v) {
        ...
        function n(a) {
            C != a ? (C &&
            E(f, m), (C = a) ? (a = new Image, a.addEventListener("load", p, m), a.src = C) : (g("#" + z.id + " " + f, {
                "background-image": ""
    ...
    h.html5.displayicon = function(c, d, f, D) {
        ...
        function s(a, c, e, j, f) {
            ...
            g.src ? (j = k.extend({}, j), 0 < c.indexOf("Icon") && (C = g.width | 0), j.width = g.width, j["background-image"] = "url(" + g.src + ")", j["background-size"] = g.width + "px " + g.height + "px", j["float"] = "none", f = k.extend({}, f), g.overSrc && (f["background-image"] =
                "url(" + g.overSrc + ")"), k.isMobile() || b("#" + d.id + " .jwdisplay:hover " + e, f), b.style(y, {
                display: "table"
            })) : b.style(y, {
                display: "none"
            });
        ...
        function j() {
            ...
            var a = "px " + g,
                c = Math.ceil(Math.max(J.width, k.bounds(y).width -
                l.width - w.width)),
                a = {
        ...
        this.setText = function(b) {
            ...
            c.display = "block";
            if (b)
                for (; 2 < Math.floor(z.scrollHeight / a.defaultView.getComputedStyle(z, null).lineHeight.replace("px", ""));) z.innerHTML =
...
(function(h) {
    ...
    k.dock = function(h, m) {
        ...
        r && (a(u(), {
            ...
            cursor: "pointer",
            border: d
        })), a(u("div.button:hover"), s(K)), a(u("div.button:active"), s(t)), a(u("div.button\x3ediv"), {
            opacity: y.iconalpha
        }), a(u("div.button:hover\x3ediv"), {
            opacity: y.iconalphaover
        }), a(u("div.button:active\x3ediv"), {
    ...
    k.player = function(a) {
        ...
        function c() {
            ...
            f.jwInstreamDestroy = function(a, b) {
                if (b = b || u) b.jwInstreamDestroy(a ||
                !1), b === u && (u = void 0)
            };
    ...
    b.view = function(w, l) {
        ...
        this.setup = function(d) {
            if (!F) {
                ...
                c("#" +
                N.id + ".playlist-bottom .jwplaylistcontainer", {
                    width: "100%",
                    height: q + "px",
                    bottom: 0
                });
    ...
    d.castDisplay = function(j) {
        ...
        this.setCompanions = function(b) {
            var c, d, e, f = Number.MAX_VALUE,
                h = null;
            for (d = b.length; d--;)
                if (c = b[d], c.width && c.height && c.source) switch (c.type) {
                    case "html":
                    case "iframe":
        ...
        this.adChanged = function(b) {
            if (b.complete) A && A.reset(-1), G = null;
                ...
                c !== G && (m(K + " .jwpreview", {
                    opacity: 0
                }), b.companions ? this.setCompanions(b.companions) : p(), b.clickthrough ? null === I && (I = a("div", "click-label"), I.innerText = "Click here to learn more \x3e",
...
(function(h) {
    ...
    h.rightclick = function(a, e) {
        if ("free" == a.edition()) e.aboutlink = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + h.version + "\x26m\x3dh\x26e\x3df", delete e.abouttext;
        else {
            if (!e.aboutlink) {
