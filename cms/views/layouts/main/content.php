...
cms\components\assets\CustomAsset::register($this);
?>
<div class="content-wrapper">
    <section class="content-header">
        <h1><?php echo isset($this->params['title']) ? $this->params['title'] : $this->title ?? '' ?></h1>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">EVG</a>.</strong> All rights
    reserved.
</footer>
