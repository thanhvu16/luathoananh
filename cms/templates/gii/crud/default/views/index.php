...
$this->params['menu'] = [
    ['label'=><?= $generator->generateString('Create') ?>, 'url' => ['create'], 'options' => ['class' => 'btn btn-primary']],
    ['label'=><?= $generator->generateString('Delete') ?>, 'url' => 'javascript:void(0)', 'options' => ['class' => 'btn btn-danger', 'onclick' => 'deleteAllItems()']]
];
?>
